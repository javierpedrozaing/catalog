...
class WWP_Store_Owner_Tips {
	...
	public function join_store_owner_tips_note() {
		...
		try{
			...
			$note->add_action( 'join-store-owner-tips', __( 'Join Store Owner Tips on Facebook', 'woocommerce-wholesale-prices' ), $join_store_owner_tips , WC_Admin_Note::E_WC_ADMIN_NOTE_ACTIONED, true );
			$note->save();
